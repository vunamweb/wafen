...
<div id="content">
    ...
    <div class="panel panel-default">
			...
			<?php if ($transaction->getTransactionObject()->isPartialCapturePossible()):?>
				<h2><?php echo PayEngine3Cw_Language::_('Partial Capture'); ?></h2>
				<p><?php echo PayEngine3Cw_Language::_('With the following form you can perform a partial capture.'); ?></p>
				<form action="<?php $captureConfirmUrl; ?>" method="POST" class="payengine3cw-line-item-grid " id="capture-form">
				
					<input type="hidden" id="payengine3cw-decimal-places" value="<?php echo Customweb_Util_Currency::getDecimalPlaces($transaction->getTransactionObject()->getCurrencyCode()); ?>" />
					<input type="hidden" id="payengine3cw-currency-code" value="<?php echo strtoupper($transaction->getTransactionObject()->getCurrencyCode()); ?>" />
					<table class="table table-bordered table-hover">
						<thead>
							<tr>
								<td class="left"><?php echo PayEngine3Cw_Language::_('Name'); ?></td>
								<td class="left"><?php echo PayEngine3Cw_Language::_('SKU'); ?></td>
								<td class="left"><?php echo PayEngine3Cw_Language::_('Type'); ?></td>
								<td class="left"><?php echo PayEngine3Cw_Language::_('Tax Rate'); ?></td>
								<td style="text-align: right;"><?php echo PayEngine3Cw_Language::_('Quantity'); ?></td>
								<td style="text-align: right;"><?php echo PayEngine3Cw_Language::_('Total Amount (excl. Tax)'); ?></td>
								<td style="text-align: right;"><?php echo PayEngine3Cw_Language::_('Total Amount (incl. Tax)'); ?></td>
								</tr>
						</thead>
						...
						<tfoot>
							<tr>
								<td colspan="6" style="text-align: right;"><?php echo PayEngine3Cw_Language::_('Total Capture Amount'); ?>:</td>
					...
					<?php if ($transaction->getTransactionObject()->isCaptureClosable()):?>
						<div class="closable-box">
							<label>
								<input id="close-transaction" type="checkbox" name="close" value="on" /> <?php echo PayEngine3Cw_Language::_('Close transaction for further captures'); ?>
							</label>
					...
					<div style="text-align: right;">
						<input type="submit" class="btn btn-success" value="<?php echo PayEngine3Cw_Language::_('Capture'); ?>" />
					</div>
				</form>
			<?php endif;?>
