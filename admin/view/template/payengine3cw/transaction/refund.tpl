...
<div id="content">
    ...
    <div class="panel panel-default">
			...
			<?php if ($transaction->getTransactionObject()->isPartialRefundPossible()):?>
				<h2><?php echo PayEngine3Cw_Language::_('Partial Refund'); ?></h2>
				<p><?php echo PayEngine3Cw_Language::_('With the following form you can perform a partial refund.'); ?></p>
				<form action="<?php $refundConfirmUrl; ?>" method="POST" class="payengine3cw-line-item-grid" id="refund-form">
					...
					<table class="table table-bordered table-hover">
						...
						<tfoot>
							<tr>
								<td colspan="6" style="text-align: right;"><?php echo PayEngine3Cw_Language::_('Total Refund Amount'); ?>:</td>
					...
					<?php if ($transaction->getTransactionObject()->isRefundClosable()):?>
						<div class="closable-box">
							<label for="close-transaction">
								...
								<?php echo PayEngine3Cw_Language::_('Close transaction for further refunds'); ?></label>
							
						</div>
					<?php endif;?>
					
					<div style="text-align: right;">
						<input type="submit" class="btn btn-success" value="<?php echo PayEngine3Cw_Language::_('Refund'); ?>" />
					</div>
				</form>
			<?php endif;?>
			</div>
