...
<div id="content">
    ...
    <div class="panel panel-default">
			...
			<table class="table table-bordered table-hover">
				<tr>
					<td><?php echo PayEngine3Cw_Language::_('Capture ID') ?></td>
					<td><?php echo $capture->getCaptureId(); ?></td>
				</tr>

				<tr>
					<td><?php echo PayEngine3Cw_Language::_('Capture Date') ?></td>
					<td><?php echo $capture->getCaptureDate()->format(Customweb_Core_Util_System::getDefaultDateTimeFormat()); ?></td>
				</tr>
				<tr>
					<td><?php echo PayEngine3Cw_Language::_('Capture Amount') ?></td>
			...
			<h2><?php echo PayEngine3Cw_Language::_('Captured Items'); ?></h2>
			<table class="table table-bordered table-hover">
				<thead>
					<tr>
