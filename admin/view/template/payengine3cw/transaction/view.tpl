...
<div id="content">
		...
		<div class="container-fluid">
			<div class="pull-right">
				...
				<?php if(is_object($transaction->getTransactionObject()) && $transaction->getTransactionObject()->isCapturePossible()): ?>
					<a href="<?php echo $capture; ?>" data-toggle="tooltip" class="btn btn-success" title="<?php echo PayEngine3Cw_Language::_('Capture Transaction'); ?>"><i class="fa fa-lock"></i></a>
				<?php endif; ?>
				
				
				<?php if(is_object($transaction->getTransactionObject()) && $transaction->getTransactionObject()->isRefundPossible()): ?>
					<a href="<?php echo $refund; ?>" data-toggle="tooltip" class="btn btn-danger" title="<?php echo PayEngine3Cw_Language::_('Refund Transaction'); ?>"><i class="fa fa-exchange"></i></a>
				<?php endif; ?>
				
				
				<?php if(is_object($transaction->getTransactionObject()) && $transaction->getTransactionObject()->isCancelPossible()): ?>
					<a href="<?php echo $cancel; ?>" data-toggle="tooltip" class="btn btn-danger" title="<?php echo PayEngine3Cw_Language::_('Cancel Transaction'); ?>"><i class="fa fa-trash"></i></a>
				<?php endif; ?>
    ...
    <div class="panel panel-default">
			...
			<table class="table table-bordered table-hover">
				...
				<tr>
					<td><?php echo PayEngine3Cw_Language::_('Payment Information') ?></td>
			...
			<?php if (is_object($transaction->getTransactionObject())): ?>
				<h2><?php echo PayEngine3Cw_Language::_('Customer Data'); ?></h2>
				<table class="table table-striped table-condensed table-hover table-bordered">
					<?php $context = $transaction->getTransactionObject()->getTransactionContext()->getOrderContext(); ?>
					<tr>
						<th class="col-lg-3"><?php echo PayEngine3Cw_Language::_('Customer ID') ?></th>
						<td><?php echo Customweb_Core_Util_Xml::escape($context->getCustomerId()); ?></td>
					</tr>
					<tr>
						<th class="col-lg-3"><?php echo PayEngine3Cw_Language::_('Billing Address') ?></th>
						<td>
							...
							<?php if ($context->getBillingDateOfBirth() !== null) :?>
								<?php echo PayEngine3Cw_Language::_('Birthday') . ': ' . $context->getBillingDateOfBirth()->format("Y-m-d"); ?><br />
							<?php endif;?>
							<?php if ($context->getBillingPhoneNumber() !== null) :?>
								<?php echo PayEngine3Cw_Language::_('Phone') . ': ' . Customweb_Core_Util_Xml::escape($context->getBillingPhoneNumber()); ?><br />
							<?php endif;?>
						</td>
					</tr>
					<tr>
						<th class="col-lg-3"><?php echo PayEngine3Cw_Language::_('Shipping Address') ?></th>
						<td>
							...
							<?php if ($context->getShippingDateOfBirth() !== null) :?>
								<?php echo PayEngine3Cw_Language::_('Birthday') . ': ' . $context->getShippingDateOfBirth()->format("Y-m-d"); ?><br />
							<?php endif;?>
							<?php if ($context->getShippingPhoneNumber() !== null) :?>
								<?php echo PayEngine3Cw_Language::_('Phone') . ': ' . Customweb_Core_Util_Xml::escape($context->getShippingPhoneNumber()); ?><br />
							<?php endif;?>
						</td>
					</tr>
				</table>
				<br />
				<h2><?php echo PayEngine3Cw_Language::_('Products'); ?></h2>
				<table class="table table-striped table-condensed table-hover table-bordered">
					<thead>
						<tr>
							<th><?php echo PayEngine3Cw_Language::_('Name'); ?></th>
							<th><?php echo PayEngine3Cw_Language::_('SKU'); ?></th>
							<th><?php echo PayEngine3Cw_Language::_('Quantity'); ?></th>
							<th><?php echo PayEngine3Cw_Language::_('Type'); ?></th>
							<th><?php echo PayEngine3Cw_Language::_('Tax Rate'); ?></th>
							<th><?php echo PayEngine3Cw_Language::_('Amount (excl. VAT)'); ?></th>
							<th><?php echo PayEngine3Cw_Language::_('Amount (inkl. VAT)'); ?></th>
						</tr>
					</thead>
					<tbody>
			...
			<h2><?php echo PayEngine3Cw_Language::_('Captures for this transaction'); ?></h2>
			<table class="table table-bordered table-hover">
				<thead>
					<tr>
						<td><?php echo PayEngine3Cw_Language::_('Date'); ?></td>
						<td><?php echo PayEngine3Cw_Language::_('Amount'); ?></td>
					...
					<tr>
						...
						<td>
							<a class="btn btn-primary"
								data-toggle="tooltip"
								href="<?php echo $url->link('payengine3cw/transaction/view_capture', 'token=' . $token . '&transaction_id=' . $transaction->getTransactionId(). '&capture_id=' . $capture->getCaptureId(), 'SSL'); ?>"
								title="<?php echo PayEngine3Cw_Language::_('View'); ?>"
							>
								<i class="fa fa-eye"></i>
							</a>
						</td>
			...
			<h2><?php echo PayEngine3Cw_Language::_('Refunds for this transaction'); ?></h2>
			<table class="table table-bordered table-hover">
				<thead>
					<tr>
						<td><?php echo PayEngine3Cw_Language::_('Date'); ?></td>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a class="btn btn-primary"
								data-toggle="tooltip"
								href="<?php echo $url->link('payengine3cw/transaction/view_refund', 'token=' . $token . '&transaction_id=' . $transaction->getTransactionId(). '&refund_id=' . $refund->getRefundId(), 'SSL'); ?>"
								title="<?php echo PayEngine3Cw_Language::_('View'); ?>"
							>
								<i class="fa fa-eye"></i>
							</a>
			...
			<h2><?php echo PayEngine3Cw_Language::_('Transactions History'); ?></h2>
			<table class="table table-bordered table-hover">
				<thead>
					<tr>
						<td><?php echo PayEngine3Cw_Language::_('Date'); ?></td>
						<td><?php echo PayEngine3Cw_Language::_('Action'); ?></td>
						<td><?php echo PayEngine3Cw_Language::_('Message'); ?></td>
					</tr>
				</thead>
				<tbody>
			...
			<h2><?php echo PayEngine3Cw_Language::_('Transactions related to the same order'); ?></h2>
			<table class="table table-bordered table-hover">
				<thead>
					<tr>
						<td><?php echo PayEngine3Cw_Language::_('Transaction Number'); ?></td>
						<td><?php echo PayEngine3Cw_Language::_('Is Authorized'); ?></td>
						<td><?php echo PayEngine3Cw_Language::_('Authorization Amount'); ?></td>
						<td></td>
					</tr>
				</thead>
				<?php foreach ($relatedTransactions as $transaction): ?>
					...
					<tr>
						...
						<a class="btn btn-primary"
								data-toggle="tooltip"
								href="<?php echo $url->link('payengine3cw/transaction/view', 'token=' . $token . '&transaction_id=' . $transaction->getTransactionId(), 'SSL'); ?>"
								title="<?php echo PayEngine3Cw_Language::_('View'); ?>"
							>
								<i class="fa fa-eye"></i>
							</a>
