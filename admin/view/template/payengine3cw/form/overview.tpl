	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right input-group">
				<a href="<?php echo $back; ?>" data-toggle="tooltip" class="btn btn-default" title="<?php echo PayEngine3Cw_Language::_('Back'); ?>"><i class="fa fa-reply"></i></a>
    ...
    <div class="panel panel-default">
			...
			<div class="panel-body backend-form">
				...
				<table class="table table-bordered table-hover">
					<thead>
						<tr>
							<td class="left"><?php echo PayEngine3Cw_Language::_('Item'); ?></td>
					...
					<?php foreach ($forms as $form): ?>
						<tr>
				            ...
				            <td style="align: right">
				            	...
				            	title="<?php echo PayEngine3Cw_Language::_('View'); ?>"><i class="fa fa-eye"></i></a>
				            </td>
				          </tr>
					<?php endforeach;?>
				</tbody>
