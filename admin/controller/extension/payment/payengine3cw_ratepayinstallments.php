...
class ControllerExtensionPaymentPayEngine3CwRatePayInstallments extends ControllerPaymentPayEngine3CwAbstract
{
	...
	public function getMachineName() {
		return 'RatePayInstallments';
	}
	public function getBackendName() {
		return 'Concardis PayEngine 3.0: RatePay Installments';
	}
	public function getFrontendName() {
		return 'RatePay Installments';
	}
}