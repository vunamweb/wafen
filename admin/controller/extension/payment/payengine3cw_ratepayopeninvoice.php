...
class ControllerExtensionPaymentPayEngine3CwRatePayOpenInvoice extends ControllerPaymentPayEngine3CwAbstract
{
	...
	public function getMachineName() {
		return 'RatePayOpenInvoice';
	}
	public function getBackendName() {
		return 'Concardis PayEngine 3.0: RatePay Open Invoice';
	}
	public function getFrontendName() {
		return 'RatePay Open Invoice';
	}
}