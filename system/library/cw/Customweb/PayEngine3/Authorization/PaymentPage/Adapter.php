 ...
 * @Bean
 */
class Customweb_PayEngine3_Authorization_PaymentPage_Adapter extends Customweb_PayEngine3_Authorization_AbstractAdapter implements 
	...
	public function getRedirectionUrl(Customweb_Payment_Authorization_ITransaction $transaction, array $formData){
		return $this->getFormActionUrl($transaction, $formData);
	}
