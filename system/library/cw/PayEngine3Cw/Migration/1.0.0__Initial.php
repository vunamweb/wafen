...
class PayEngine3Cw_Migration_1_0_0 implements Customweb_Database_Migration_IScript{
	...
	public function execute(Customweb_Database_IDriver $driver) {
		...
		$driver->query("CREATE TABLE IF NOT EXISTS " . DB_PREFIX . "payengine3cw_customer_contexts (
		...
		$driver->query("CREATE TABLE IF NOT EXISTS `payengine3cw_storage` (
		...
		$driver->query("CREATE TABLE IF NOT EXISTS " . DB_PREFIX . "payengine3cw_transactions (
		...
		PayEngine3Cw_Database::getInstance()->query("ALTER TABLE " . DB_PREFIX . "extension CHANGE `code` `code` VARCHAR( 64 )");
		
		PayEngine3Cw_OrderStatus::installOrderStatuses();
