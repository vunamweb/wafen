 ...
 * @Bean
 */
class PayEngine3Cw_EndpointAdapter extends Customweb_Payment_Endpoint_AbstractAdapter implements Customweb_Payment_Endpoint_IAdapter
{
	protected function getBaseUrl() {
		return PayEngine3Cw_Util::getUrl('endpoint');
	}
