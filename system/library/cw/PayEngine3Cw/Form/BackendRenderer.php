...
class PayEngine3Cw_Form_BackendRenderer extends PayEngine3Cw_Form_FrontendRenderer {
	private $configurationAdapter = null;

	public function __construct(){
		$this->configurationAdapter = new PayEngine3Cw_Configuration();
	}

	protected function renderElementScope(Customweb_Form_IElement $element){
		if ($this->configurationAdapter->getStoreHierarchy() === null ||
				 PayEngine3Cw_Store::getStoreId() == PayEngine3Cw_Store::DEFAULT_STORE_ID) {
			return '';
		}
