...
require_once 'PayEngine3Cw/LoggingListener.php';
require_once 'PayEngine3Cw/Configuration.php';


class PayEngine3Cw_LoggingListener implements Customweb_Core_Logger_IListener{
	...
	public function addLogEntry($loggerName, $level, $message, Exception $e = null, $object = null){
		...
		if(self::$logger == null){
			self::$logger =  new Log('PayEngine3Cw.log');
		}
	...
	private function isLevelActive($level){
		switch (PayEngine3Cw_Configuration::getLoggingLevel()) {
			case 'debug':
				return true;
			case 'info':
...
Customweb_Core_Logger_Factory::addListener(new PayEngine3Cw_LoggingListener());