...
require_once 'PayEngine3Cw/IncompleteDataException.php';
 ...
 *
 */
abstract class PayEngine3Cw_AbstractOrderContext extends Customweb_Payment_Authorization_OrderContext_AbstractDeprecated implements Customweb_Payment_Authorization_IOrderContext
{
	/**
	...
	public function __construct(Customweb_Payment_Authorization_IPaymentMethod $paymentMethod) {
		...
		if (!isset($_SESSION['payengine3cw_checkout_id'])) {
			$_SESSION['payengine3cw_checkout_id'] = array();
		}
		if (!isset($_SESSION['payengine3cw_checkout_id'][$paymentMethod->getPaymentMethodName()])) {
			$_SESSION['payengine3cw_checkout_id'][$paymentMethod->getPaymentMethodName()] = Customweb_Core_Util_Rand::getUuid();
		}
		$this->checkoutId = $_SESSION['payengine3cw_checkout_id'][$paymentMethod->getPaymentMethodName()];
	}
	...
	public function getShippingMethod() {
		...
		if (isset($totals['shipping']['title'])) {
			...
			return PayEngine3Cw_Language::_('No Shipping');
		}
	}
	...
	public function getBillingCountryIsoCode() {
		...
		if (!isset($data['iso_code_2'])) {
			throw new PayEngine3Cw_IncompleteDataException("No billing country code was set.");
		}
