...
class PayEngine3Cw_PaymentMethodWrapper implements Customweb_Payment_Authorization_IPaymentMethod, PayEngine3Cw_IPaymentMethodDefinition {
	...
	public function __construct(PayEngine3Cw_PaymentMethod $method) {
	...
	/**
	 * @return  PayEngine3Cw_PaymentMethod
	 */
	protected function getMethod() {
		if ($this->method === null) {
			$this->method = new PayEngine3Cw_PaymentMethod($this);
		}
		return $this->method;
	}
