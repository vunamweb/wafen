...
class PayEngine3Cw_Language {
	...
	public static function getLanguages(){
		if (self::$languages === null) {
			...
			$rs = PayEngine3Cw_Database::getInstance()->query("SELECT * FROM `" . DB_PREFIX . "language`");
			while (($row = PayEngine3Cw_Database::getInstance()->fetch($rs)) !== false) {
	...
	public static function getCurrentLanguageId(){
		$config = PayEngine3Cw_Util::getRegistry()->get('config');
