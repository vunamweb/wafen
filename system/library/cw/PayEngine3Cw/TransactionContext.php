...
class PayEngine3Cw_TransactionContext implements Customweb_Payment_Authorization_PaymentPage_ITransactionContext,
...
Customweb_Payment_Authorization_IUpdateTransactionContext, Customweb_Payment_Authorization_Widget_ITransactionContext
{
	...
	public function __construct(PayEngine3Cw_Entity_Transaction $transaction, PayEngine3Cw_OrderContext $orderContext, $aliasTransactionId = NULL) {
		...
		$this->paymentCustomerContext = PayEngine3Cw_Util::getPaymentCustomerContext($orderContext->getCustomerId());
	...
	public function getDatabaseTransaction() {
		if ($this->databaseTransaction === NULL) {
			$this->databaseTransaction = PayEngine3Cw_Entity_Transaction::loadById($this->databaseTransactionId);
		}
	...
	public function getAlias() {
		...
		if ($this->aliasTransactionId !== null) {
			$transcation = PayEngine3Cw_Entity_Transaction::loadById($this->aliasTransactionId);
	...
	public function getSuccessUrl() {
		return PayEngine3Cw_Util::getUrl('process', 'success', array(), true);
	}

	public function getFailedUrl() {
		return PayEngine3Cw_Util::getUrl('process', 'failed', array(), true);
	}
	...
	public function getNotificationUrl() {
		return PayEngine3Cw_Util::getUrl('process', 'notify', array(), true);
	}

	public function getIframeBreakOutUrl() {
		return PayEngine3Cw_Util::getUrl('process', 'iframe_breakout', array(), true);
	}

	public function getUpdateUrl() {
		return PayEngine3Cw_Util::getUrl('update', 'notify', array(), true);
	}
