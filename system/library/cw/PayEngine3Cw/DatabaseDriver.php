...
require_once 'PayEngine3Cw/DatabaseStatement.php';
 ...
 *
 */
class PayEngine3Cw_DatabaseDriver extends Customweb_Database_Driver_AbstractDriver implements Customweb_Database_IDriver {
	...
	public function __construct(){
		$this->db = PayEngine3Cw_Util::getDatabaseObject();
	}
	...
	public function query($query){
		$statement = new PayEngine3Cw_DatabaseStatement($query, $this);
		return $statement;
	}
