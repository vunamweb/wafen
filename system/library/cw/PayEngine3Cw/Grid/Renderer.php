...
class PayEngine3Cw_Grid_Renderer extends Customweb_Grid_Renderer {
	...
	public function getInfoPattern() {
		return PayEngine3Cw_Language::_('Showing !startingItem to !endingItem of !totalItems items.');
	}
	
	public function getSubmitButtonLabel() {
		return PayEngine3Cw_Language::_('Apply');
	}
