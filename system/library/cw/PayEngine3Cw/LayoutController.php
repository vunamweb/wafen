...
class PayEngine3Cw_LayoutController extends PayEngine3Cw_AbstractController
{
	/**
	...
	public function __construct(Customweb_Mvc_Layout_IRenderContext $context) {
		parent::__construct(PayEngine3Cw_Util::getRegistry());
	...
	public function getContent() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payengine3cw/default.tpl')) {
			$template = $this->config->get('config_template') . '/template/payengine3cw/default.tpl';
		}
		else {
			$template = 'default/template/payengine3cw/default.tpl';
		}
