 ...
 * @Bean
 */
class PayEngine3Cw_Adapter_IframeAdapter extends PayEngine3Cw_Adapter_AbstractAdapter {
	...
	protected function preparePaymentFormPane(){
		...
		if ($this->visibleFormFields !== null && count($this->visibleFormFields) > 0) {
			$this->formActionUrl = PayEngine3Cw_Util::getUrl('process', 'iframe', 
					array(
	...
	public function getIframe(){
		if ($this->iframeUrl !== null) {
			return '<iframe class="payengine3cw-iframe" src="' . $this->iframeUrl . '" style="height: ' . $this->iframeHeight . 'px;"></iframe>';
		}
		else {
