...
class ControllerProductManufacturer extends Controller {
	...
	public function info() {
        ...
        $data['des']=html_entity_decode($manufacturer_info['des']);
        $data['name_manufacture']=html_entity_decode($manufacturer_info['name']);
        $data['img_manufacture']=html_entity_decode($manufacturer_info['image']);
