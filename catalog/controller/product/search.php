...
class ControllerProductSearch extends Controller {
	public function index() {
		...
		$data['products'] = array();
        $data['list_filter']=$this->model_catalog_product->getListFilter();
        if (true) {
		//if (isset($this->request->get['search']) || isset($this->request->get['tag'])) {
            ...
            $product_total = $this->model_catalog_product->getTotalProductsSearch($filter_data);
			...
			foreach ($results as $result) {
				...
				$data['products'][] = array(
					'filter' => $this->model_catalog_product->getNameFilter($result['product_id']),
