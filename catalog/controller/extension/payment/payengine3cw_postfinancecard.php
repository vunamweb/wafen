...
class ControllerExtensionPaymentPayEngine3CwPostFinanceCard extends ControllerPaymentPayEngine3CwAbstract
{
	...
	public function getBackendName() {
		return 'Concardis PayEngine 3.0: PostFinance Card';
	}
