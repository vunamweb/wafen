...
class ControllerExtensionTotalShipping extends Controller {
	...
	public function quote() {
		...
		if (!$json) {
            ...
            $quote_data['weight']['title']='';
            if(isset($quote_data['weight']['quote']['weight_4']['title']))
              $quote_data['weight']['quote']['weight_4']['title']='Deutschland';
            if(isset($quote_data['weight']['quote']['weight_3']['title']))
              $quote_data['weight']['quote']['weight_3']['title']='Out Deutschland';
