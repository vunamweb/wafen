...
<div class="section latest">
 <div class="section-heading"><?php echo $heading_title; ?></div>
  <div class="section-block">
	...
	<div class="section-product <?php if ($productCount >= $sliderFor){?>product-carousel<?php }else{?>grid<?php }?>">
  <?php foreach ($products as $product) { ?>
  <div class="<?php if ($productCount >= $sliderFor){?>slider-item<?php }else{?>product-items col-xs-4 col-sm-4 col-md-3<?php }?>">
