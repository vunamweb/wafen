...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
		...
		<div class="row">
			<div class="col-md-4"><?php if($img_manufacture) { ?> <img src="/mthumb.php?w=200&amp;src=image/<?php echo $img_manufacture; ?>" alt="<?php echo $name_manufacture; ?> Logo" /><?php } ?></div>
			<div class="col-md-8">
				<h2><?php echo $name_manufacture; ?></h2>
				<div style="padding-bottom:30px"><?php echo $des; ?></div>
			</div>
			<div class="col-md-12">
				<hr>
				&nbsp;
			...
			<div class="col-md-12">
				<h2 style="margin-bottom: 1em; text-transform: inherit;">Unsere Messerauswahl des Herstellers <strong><?php echo $name_manufacture; ?></strong></h2>
			</div>
		</div>
