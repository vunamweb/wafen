...
<?php
    ...
    $domain = urlencode($url);
?>
	          	<h3>PRODUKT EMPFEHLEN</h3>
	          	<ul class="social">
		          	<li><a href="https://www.xing.com/app/user?op=share;url=<?php echo $domain; ?>" target="_blank" title="Empfehlung bei XING" class="xi"><i class="fa fa-xing"></i></a></li>
		          	<li><a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $domain; ?>" target="_blank" title="Empfehlung bei facebook" class="fb"><i class="fa fa-facebook"></i></a></li>
	          	</ul>
            <?php if ($minimum > 1) { ?>
	 ...
	 <?php } ?>
      ...
      <div class="product-tag"><b><?php echo $text_tags; ?></b>
        ...
        <a href="<?php echo $tags[$i]['href']; ?>" class="underline"><?php echo $tags[$i]['tag']; ?></a>
        <?php } else { ?>
        <a href="<?php echo $tags[$i]['href']; ?>" class="underline"><?php echo $tags[$i]['tag']; ?></a>
        <?php } ?>
        <?php } ?>
...
<p style="margin-top: 2em;"><a href="javascript:void(0)" onclick="window.history.go(-1);"><i class="fa fa-chevron-left"></i> Zurück</a></p>
</div>
