...
<div class="quickviewblock">
        ...
        <div class="col-sm-6">
          ...
          <ul class="thumbnails">
            ...
            <li><a class="cloud-zoom" href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" rel="transparentImage: 'data:image/gif;base64,R0lGODlhAQABAID/AMDAwAAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==', useWrapper: false, showTitle: true, zoomWidth:'300', zoomHeight:'400', adjustY:0, adjustX:10"><img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></a></li>
        ...
        <div class="col-sm-6">
          ...
          <h1 class="productpage-title"><?php echo $heading_title; ?></h1>
        <?php if ($price) { ?>
        ...
        <?php } ?>
         <ul class="list-unstyled detail">
          ...
          <div id="product">
            <?php if ($options) { ?>
            <hr>
             <h3 class="product-option"><?php echo $text_option; ?></span>
            ...
            <div class="form-group">
              ...
              <input type="text" name="quantity" value="<?php echo $minimum; ?>" size="2" id="input-quantity" class="form-control productpage-qty" />
              <input type="hidden" name="product_id" value="<?php echo $product_id; ?>" />
             <button type="button" id="button-cart2" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary btn-lg btn-block addtocart"><?php echo $button_cart; ?></button>
              <br/>
             <div class="btn-group">
				...
				<button type="button" data-toggle="tooltip" class="btn btn-default compare" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product_id; ?>');"><i class="fa fa-exchange"></i></button>
			</div>
            </div>
            <?php if ($minimum > 1) { ?>
...
$('#button-cart2').on('click', function() {
	$.ajax({
		...
		success: function(json) {
			...
			if (json['success']) {
				$('body').before('<div class="alert alert-success container">' + json['success'] + '<button type="button" class="close" data-dismiss="alert">&times;</button></div>');
