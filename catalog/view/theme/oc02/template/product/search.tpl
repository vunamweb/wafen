    ...
    <div id="content" class="<?php echo $class; ?> search"><?php echo $content_top; ?>
      ...
      <div class="row">
        <div class="col-xs-4 col-sm-4" style="display:none">
         <input  type="text" name="searchdddd" value="<?php echo $search; ?>" placeholder="<?php echo $text_keyword; ?>" id="input-search" class="form-control" />
        </div>
        ...
        <div class="col-xs-6 col-sm-6 sort">
          <select name="search" class="form-control" id="input-search" >
            <option value="0">Filter</option>
            <?php foreach ($list_filter as $item) { ?>
               
               <?php if ($item['value'] == $search) { ?>
...
$('#button-search').bind('click', function() {
    ...
    var filter_str = $('#content select[name=\'search\']').prop('value');
	
	if (filter_str != 0) {
		url += '&search=' + encodeURIComponent(filter_str);
	}
