	  ...
	  <div class="panel panel-default">
        <div class="row">
          <div class="form-group">
            <label class="col-sm-2 control-label text-left"><b><?php echo $entry_author; ?></b></label>
            <div class="col-sm-6"> : <?php echo $blog_comment['author']; ?></div>
            <label class="col-sm-2 control-label text-right"><b><?php echo $text_date_added; ?></b></label>
            <div class="col-sm-2"> : <?php echo $blog_comment['date_added']; ?></div>
          </div>
        </div>
        <div class="row">
          <div class="form-group">
            <label class="col-sm-2 control-label text-left"><b><?php echo $entry_comment; ?></b></label>
            <div class="col-sm-10"> : <?php echo $blog_comment['comment']; ?></div>
          </div>
        </div>
      </div>
	  </div>
